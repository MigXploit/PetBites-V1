...
<header>
  <nav>
    ...
    <ul class="nav-links">
      ...
      <li><a href="pages/membresia.html">Membresía</a></li>
      <li><a href="pages/contacto.html">Contacto</a></li>
      <li><a href="pages/registro.html" class="nav-cta">¡Regístrate!</a></li>
    </ul>
    <div class="hamburger">
  ...
  <div class="mobile-menu">
    ...
    <a href="pages/membresia.html">⭐ Membresía</a>
...
<footer>
  <div class="footer-grid">
    <div class="footer-brand">
      <svg viewBox="0 0 220 56" xmlns="http://www.w3.org/2000/svg" class="logo-svg" style="filter: brightness(2)">
        <text x="0" y="44" font-family="Fredoka One, cursive" font-size="46" font-weight="900" fill="white" letter-spacing="-1">PET</text>
        <text x="110" y="44" font-family="Fredoka One, cursive" font-size="42" fill="white">Bites</text>
        <path d="M114 10 C114 7, 112 5, 110 7 C108 5, 106 7, 106 10 C106 13, 110 16, 110 16 C110 16, 114 13, 114 10Z" fill="#05C9B4"/>
        <rect x="84" y="22" width="22" height="5" rx="2.5" fill="#05C9B4"/>
      </svg>
    ...
    <div class="footer-col">
      <h4>Servicios</h4>
      <ul>
        <li><a href="pages/servicios.html">Plan Nutricional</a></li>
        <li><a href="pages/servicios.html">Seguimiento</a></li>
        <li><a href="pages/servicios.html">Retroalimentación</a></li>
        <li><a href="pages/membresia.html">Membresía Premium</a></li>
        <li><a href="pages/registro.html">Registro de Mascota</a></li>
      </ul>
    </div>
    <div class="footer-col">
      <h4>Contacto</h4>
